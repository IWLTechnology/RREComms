function send() {
  if(document.getElementById('post').value != "" && document.getElementById('post').value != undefined && document.getElementById('post').value != "NaN" && document.getElementById('post').value != "undefined"){
...
function checkAuthor(id) {
  ...
  x.getElementsByClassName("senderHeader")[0].innerHTML =
    `&nbsp; (${author}) sent:`;
...
Your browser does not support the video tag.
      ...
      document.getElementById("post").value +=
        `<iframe width="100%" height="auto" src="https://www.youtube.com/embed/${source}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;
    }
  }
}
function audio() {
...
function link() {
  ...
  if (source != null) {
    if (txt != "") {
      document.getElementById("post").value +=
        `<a href="${source}" target="_blank">${txt}</a>`;
    } else {
      document.getElementById("post").value +=
...
function settings(input) {
  switch (input) {
    ...
    case 1:
      ...
      document.getElementById('muteAllSound').innerHTML = document.getElementById('muteAllSound2').innerHTML;
      document.getElementById('postSound').innerHTML = document.getElementById('postSound2').innerHTML;
      document.getElementById('deleteSound').innerHTML = document.getElementById('deleteSound2').innerHTML;
      document.getElementById('newSound').innerHTML = document.getElementById('newSound2').innerHTML;
      break;
    case 2:
      document.getElementById('muteAllSound2').innerHTML = document.getElementById('muteAllSound').innerHTML;
      document.getElementById('postSound2').innerHTML = document.getElementById('postSound').innerHTML;
      document.getElementById('deleteSound2').innerHTML = document.getElementById('deleteSound').innerHTML;
      document.getElementById('newSound2').innerHTML = document.getElementById('newSound').innerHTML;
      document.getElementById("enabled").style.display = "block";
      document.getElementById("settings").style.display = "none";
      break;
  }
